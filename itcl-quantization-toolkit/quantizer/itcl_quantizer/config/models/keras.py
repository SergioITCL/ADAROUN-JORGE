...
_adround_optimizers = RoundingMinimaCfg | RoundingAnnealerCfg 
# endregion AdaRound
...
class QuantizerCfg(BaseModel):
    ...
    ada_round_net: _adround_optimizers | None = Field(
        default_factory=RoundingAnnealerCfg
    )
    param_equalizer: ParamEqualizerCfg | None = Field(default_factory=ParamEqualizerCfg)
