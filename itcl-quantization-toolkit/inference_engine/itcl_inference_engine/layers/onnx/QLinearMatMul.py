...
class QLinearMatMul(IOperator):
    ...
    def __init__(self,  input_scale, input_zerop, weights_tensor, w_scale, w_zerop,  out_scale, out_zerop) -> None:
        """_summary_
    ...
    def from_model(cls, operator: Operator):
        ...
        b_tensor = np.array(
            b_tensor_def["tensor"], dtype=b_tensor_def["dtype"])
    ...
    def infer(self, input: np.ndarray):
        ...
        """
        i = input.astype(np.int32) - self.__i_zp  # As int32
