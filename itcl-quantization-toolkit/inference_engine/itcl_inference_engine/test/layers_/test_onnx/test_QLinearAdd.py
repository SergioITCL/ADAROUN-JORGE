...
class TestQLinearAdd():
    def test_op(self):
        ...
        add_op = QLinearAdd(a_scale, a_zero_point, b, b_scale,
    ...
    def test_op_2(self):
        ...
        a = np.array([[119, 130, 131, 132, 137, 139,
                       129, 116, 131, 125, 133,
                       139, 117, 138, 134, 137, 130,
                       133, 118, 120, 125, 131, 127, 133, 142, 127, 120, 131, 138, 127, 119, 126]])

        a_scale = np.array([0.01712208241224289], dtype=np.float32)
        a_zero_point = np.array([129], dtype=np.uint8)

        b = np.array([
            65, 153, 68, 187, 95, 119, 0,
            58, 115, 255, 68, 70, 129, 189, 108,
            62, 147, 139, 59, 75, 63, 82, 90, 67,
            75, 63, 91, 172, 31, 150, 144, 155])
        ...
        output = np.array([[114, 133, 126, 139, 135,
                            139, 117, 110, 131, 139,
                            128, 134, 118, 145, 133,
                            131, 133, 135, 112, 116,
                            119, 127, 124, 128, 137,
                            121, 117, 136, 129,
                            130, 122, 130]], dtype=np.uint8)
